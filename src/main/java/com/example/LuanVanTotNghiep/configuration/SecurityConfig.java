...
public class SecurityConfig {
    ...
    private final String[]  PUBLIC_ENOPOINTS_GET={"/program-true","/groups-true","/schedules","/list-pbs/{schedule_id}","/branch-by-group-program","/branchs-by-program/{program_id}","/programs-by-branch/{branch_id}","/groups-by-branch/{branch_id}","/groups","/university","/api/excel/download","/branch","/program", "/api/methods/getMethodById/{method_id}", "/api/methods/getAllMethods"};
    private final String[] ADMIN_POST={"/create-list-pbs","/schedule","/create-branch-program","/admin/create-cadre","/groups","/university","/branch","/create-branch-group","/program"};
